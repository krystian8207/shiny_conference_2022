# module wrapped into single app
...
edit_panel_server <- function(input, output, session, var_id) {
...
server <- function(input, output, session) {
  ...
  edit_panel_server(input, output, session, "age")
}
